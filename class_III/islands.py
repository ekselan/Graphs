...
# the number of 1 islands. An island consists of 1s that
# are connected to the north, south, east or west.
#
# For example:
islands = [[0, 1, 0, 1, 0],
           [1, 1, 0, 1, 1],
...
# What are the neighbors of (1,3) (row1, column3)
# Answer: (0,3), (1,4)

# Using "parallel arrays" approach
